...
public class InstrumentTest {
   ...
   public void testAlternateFingerings() {
      ...
      Chord fMajor = new Chord(new Note(NoteName.F, 0), ChordType.MAJOR);
      FretboardModel fretboard = new FretboardModel(Instrument.GUITAR, fMajor);
      ...
      for (ChordFingering fingering : chords) {
         ...
         if (fingering.isBarred) {

            System.out.println(Arrays.toString(fingering.absoluteFrets));
         }
      }
   }

   private void sortChords(List<ChordFingering> chords) {
